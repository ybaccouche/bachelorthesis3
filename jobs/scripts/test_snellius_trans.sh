#!/bin/bash
#SBATCH --job-name=trans_final_pr                    # Job name
...
python /home/scur2273/bachelorthesis3/ev_transformer.py #--batch_size 32 --num_batches 1000 #--lr 0.001 --nblocks 8 --nheads 12
