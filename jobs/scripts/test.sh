...
#SBATCH --time00:01:00                     # Time limit hrs:min:sec
...
python /home/ybe320/Thesis/bachelor-thesis3/bachelorthesis3/final_transformer.py --batch_size 32 --num_batches 1000 --epochs 1000 --lr 0.001 --heads 8 --depth 12
