...
#SBATCH --time=02:15:00                     # Time limit hrs:min:sec
...
python /home/ybe320/Thesis/bachelor-thesis3/bachelorthesis3/ev_percreiver.py.py #--batch_size 32 --num_batches 1000 #--lr 0.001 --nblocks 8 --nheads 12
