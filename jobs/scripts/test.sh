...
#SBATCH --time00:15:00                     # Time limit hrs:min:sec
...
python /home/ybe320/Thesis/bachelor-thesis3/bachelorthesis3/ev_transformer.py #--batch_size 32 --epochs 1000 --lr 0.001 --heads 8 --depth 12
